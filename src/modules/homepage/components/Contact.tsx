...
const Contact = () => {
  ...
  return (
    <section className="space-y-5">
      ...
      <div
        className="bg-[#bfbeef] text-neutral-900 border p-8 rounded-xl space-y-5 bg-no-repeat bg-right"
      ...
      >
        ...
        <div className="space-y-3">
          ...
          <div
            ...
            onClick={() => handleEmailClick("cristian.figueroa.crfe@gmail.com")}
            data-umami-event="Click : Email"
          >
            {copiedEmail ? "Copied!" : "cristian.figueroa.crfe@gmail.com"}
          </div>
        </div>
